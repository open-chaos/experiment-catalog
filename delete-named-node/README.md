...
(chaostk) $ export APPLICATION_ENTRYPOINT_URL=http://192.168.99.100/myapp; \
          ...
          $ export NODE_NAME=mynode; \
                   chaos run https://raw.githubusercontent.com/open-chaos/experiment-catalog/master/delete-named-node/delete-named-node-exeriment.json
```
...
$ docker run -it \
           ...
           run https://raw.githubusercontent.com/open-chaos/experiment-catalog/master/delete-named-node/delete-named-node-exeriment.json
```
...
$ docker run -it \
           ...
           -v ~/.chaostoolkit:/tmp/settings \
             chaostoolkit/chaostoolkit \
           --settings /tmp/settings/settings.yaml \
           run delete-named-node-exeriment.json
```
